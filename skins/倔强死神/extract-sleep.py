...
源: uploads/1783419218176-image.png
- 1920x1920 RGB, 白底, 豆包水印在右下角
- 表情: 闭眼 + 双手合掌托腮 + 镰刀在身侧
- 睡意朦胧

输出: frames/pet-sleep.png (2048x2048 RGBA, 主体填满)
"""
from PIL import Image
import numpy as np
from collections import deque

SRC = r"C:\Users\12690\.mavis\uploads\1783419218176-image.png"
DST = r"F:\MinMax Code\0629\desktop-pet\skins\死神倔强卜\frames\pet-sleep.png"
