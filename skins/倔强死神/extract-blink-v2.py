"""倔强死神 blink PNG 抠图 v2 —— 基于新出图（无装饰背景）。

源: F:\MinMax Code\0629\matrix-media-1783421082522-1196f095.png
- 1920x1920 RGB, 纯白底 (无装饰)
- 表情: 眯眼笑 + 微笑嘴
...
print(f"右下角 alpha: {out[2000:, 1800:, 3].max()}")