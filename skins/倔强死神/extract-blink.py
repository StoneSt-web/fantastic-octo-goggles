...
源: uploads/1783420455721-image.png
- 1920x1920 RGB, 白底, 豆包水印在右下角
- 背景有浅灰色椭圆装饰（抠图时会被 BFS 删掉）
- 表情: 眯眼笑 (眼睛弯成弧线) + 微笑嘴
- 双手持镰刀

输出: frames/pet-eye-closed.png (2048x2048 RGBA, 主体填满)
"""
from PIL import Image
import numpy as np
from collections import deque

SRC = r"C:\Users\12690\.mavis\uploads\1783420455721-image.png"
...
# === Step 3: BFS 抠白底 + 浅灰椭圆 + 装饰笔触 ===
# 这张图背景有：白底 + 浅灰椭圆 + 白色动感线条装饰
# 阈值放宽: sat < 25 & avg > 200 (能识别更多"近白"装饰)
# 风险：可能误删角色内的浅色高光
...
print(f"背景像素 (白+浅灰+装饰): {is_bg.sum()}")
